...
// Bir asi kaydinin durumu: administered_date doluysa 'yapildi';
// bossa planned_date'e gore 'overdue' (zamani gecti) ya da 'planned' (planlandi).
...
// Standart yavru asi programlari. "weeks" = baslangic tarihinden itibaren kac hafta sonra (1'er hafta ara ile).
...
// Bir asi "Yapildi" olarak isaretlendiginde, otomatik olusturulacak bir sonraki
// plani hesaplar. Kural: Ic Dis Parazit her uygulamadan 2 ay sonra tekrar eder;
// "X 2" adli (2. doz) bir asi Yapildi olunca 1 yil sonrasi icin "Yillik X" olusur;
// "Yillik X" Yapildi olunca yine 1 yil sonrasi icin ayni isimle devam eder.
// Kuduz ve tekli (1. doz) asilar bu otomatik zinciri tetiklemez.
...
// Hasta sahiplerine yonelik, tur bazli otomatik bilgilendirme icerigi.
